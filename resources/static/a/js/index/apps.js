...
handleSidebarMenu = function () {
  ...
  $('.sidebar .nav > .has-sub > a').click(function () {
    ...
    0 === $('.page-sidebar-minified').length && ($(e).closest('li').addClass('closing'), $(e).slideUp(t, function () {
      ...
      $(a).is(':visible') ? ($(e).addClass('expand'), $(e).removeClass('closed'))  : ($(e).addClass('closed'), $(e).removeClass('expand')),
...
handleMobileSidebarToggle = function () {
  ...
  $(document).bind('click touchstart', function (e) {
    ...
    e.isPropagationStopped() || !0 === n || ($('#page-container').hasClass('page-sidebar-toggled') && (n = !0, $('#page-container').removeClass('page-sidebar-toggled')), $(window).width() <= 767 && $('#page-container').hasClass('page-right-sidebar-toggled') && (n = !0, $('#page-container').removeClass('page-right-sidebar-toggled')))
  }),
  ...
  $('[data-click=sidebar-toggled]').click(function (e) {
    ...
    t = '#page-container';
    $(t).hasClass(a) ? $(t).removeClass(a)  : !0 !== n ? $(t).addClass(a)  : n = !1,
...
handleSidebarMinify = function () {
  $(document).on('click', '[data-click=sidebar-minify]', function (e) {
    ...
    t = '#page-container';
    $(t).hasClass(a) ? $(t).removeClass(a)  : ($(t).addClass(a), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && ($('#sidebar [data-scrollbar="true"]').css('margin-top', '0'), $('#sidebar [data-scrollbar="true"]').css('overflow-x', 'scroll'))),
    $(window).trigger('resize')
  })
},
...
handlePanelAction = function () {
  ...
  $(document).on('click', '[data-click=panel-remove]', function (e) {
    ...
    4 <= a && a < 5 ? $(this).tooltip('dispose')  : $(this).tooltip('destroy'),
...
//    2 == $(this).val() ? $('#sidebar').addClass('sidebar-grid')  : $('#sidebar').removeClass('sidebar-grid'),
...
//    2 == $(this).val() ? $('#page-container').addClass('gradient-enabled')  : $('#page-container').removeClass('gradient-enabled'),
...
//    2 == $(this).val() ? $('body').addClass('flat-black')  : $('body').removeClass('flat-black'),
...
//    2 == $(this).val() ? $('body').addClass('rtl-mode')  : $('body').removeClass('rtl-mode'),
  ...
  function a(e, a) {
    ...
    switch ($(t).find('li').each(function () {
      ...
      case 'next':
        ...
        0 !== l && ($('body').hasClass('rtl-mode') ? $(t).find('.nav.nav-tabs').animate({
          marginRight: '-' + l + 'px'
        }, 150, function () {
      ...
      case 'prev':
        var r;
        (r = - o) <= i ? ($(t).removeClass('overflow-left'), l = 0)  : l = r - i + 80,
        $('body').hasClass('rtl-mode') ? $(t).find('.nav.nav-tabs').animate({
          marginRight: '-' + l + 'px'
        }, 150, function () {
    ...
    $('.tab-overflow').each(function () {
      !function (e, a) {
        ...
        if ($(e).find(t).prevAll().each(function () {
          ...
          var r = i - o;
          l != i && (r += 40),
          $('body').hasClass('rtl-mode') ? $(e).find('.nav.nav-tabs').animate({
            marginRight: '-' + r + 'px'
          }, s)  : $(e).find('.nav.nav-tabs').animate({
            marginLeft: '-' + r + 'px'
          }, s)
        }
        i != l && o <= l ? $(e).addClass('overflow-right')  : $(e).removeClass('overflow-right'),
        o <= i && o <= l ? $(e).addClass('overflow-left')  : $(e).removeClass('overflow-left')
      }(this, 0)
    })
  }
  ...
  function a(e, a) {
    ...
    switch ($(t).find('li').each(function () {
      ...
      case 'next':
        ...
        0 !== l && ($('body').hasClass('rtl-mode') ? $(t).animate({
          marginRight: '-' + l + 'px'
        }, 150, function () {
      ...
      case 'prev':
        var r;
        (r = - o) <= i ? ($(t).find('.menu-control.menu-control-left').removeClass('show'), l = 0)  : l = r - i + 88,
        $('body').hasClass('rtl-mode') ? $(t).animate({
          marginRight: '-' + l + 'px'
        }, 150, function () {
...
handleToggleNavProfile = function () {
  ...
  $('[data-toggle="nav-profile"]').click(function (e) {
    ...
    $(t).slideToggle(i, function () {
      $(t).is(':visible') ? ($(t).addClass('expand'), $(t).removeClass('closed'))  : ($(t).addClass('closed'), $(t).removeClass('expand')),
      $(t).removeClass(n + ' ' + o)
    })
  })
},
...
handleSidebarMinifyFloatMenu = function () {
  $(document).on('click', '#float-sub-menu li.has-sub > a', function (e) {
    ...
    $(a).slideToggle({
      ...
      complete: function () {
        $(a).is(':visible') ? $(t).addClass('expand')  : $(t).addClass('closed'),
